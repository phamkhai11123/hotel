						...
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item w-100 text-right"><a href="#">
								...
								if(!isset($_SESSION['fullname']))
								{
									...
									echo '<li><b>' . $_SESSION['fullname'] . '</b></span></li>' ;
							       	echo '<li><span></span><a href="./admin/logout.php">Đăng xuất</a></li>';
								}
								?>
							</a></li>
						</ul>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Số điện thoại :</strong>+84 099999999</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SUNRISE.COM</a></p>
			<p class="contact-agile1"><strong>Địa chỉ :</strong> Sơn Tây, Hà Nội</p>
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d28628.250334830584!2d105.79930571157965!3d21.032684259498918!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1za2jDoWNoIHPhuqFuIDUgc2FvIGjDoCBu4buZaQ!5e1!3m2!1svi!2s!4v1702560487457!5m2!1svi!2s>" ></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
