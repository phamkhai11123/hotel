                ...
                <div class="row">
                    ...
                    <div class="panel panel-info">
						...
						<form method="post" id="confirmationForm">
							...
							<button type="button" class="btn btn-danger" id="rejectButton" data-toggle="modal" data-target="#confirmModal">Reject</button>
						</form>
                        </div>
                    </div>
					</div>
					...
					if (isset($_POST['delete'])) {
						...
						if (mysqli_query($con, $deleteSql)) {
							echo "<script type='text/javascript'> alert('Đơn đặt phòng đã bị từ chối và đã được xóa')</script>";
							echo "<script type='text/javascript'> window.location='roombook.php'</script>";
						} else {
							echo "<script type='text/javascript'> alert('Đã xảy ra lỗi khi xóa đơn đặt phòng')</script>";
						}
					}
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						Bạn có chắc chắc muốn xóa đơn đặt này?
					</div>
