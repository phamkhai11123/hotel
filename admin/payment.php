									...
									<?php
										...
										while($row = mysqli_fetch_array($re))
										{
                                            ...
                                            if ($roomType == 'Phòng cao cấp') {
                                                $deposit = $depositPercentage * 220;
                                            } elseif ($roomType == 'Phòng sang trọng') {
                                                $deposit = $depositPercentage * 320;
                                            } elseif ($roomType == 'Phòng khách') {
                                                $deposit = $depositPercentage * 180;
                                            } elseif ($roomType == 'Phòng đơn') {
                                                $deposit = $depositPercentage * 150;
                                            } else {
											...
											if($id % 2 ==1 )
											{
                                                ...
                                                <td>".$row['title']." ".$row['lname']." ".$row['fname']." </td>
													<td>".$row['troom']."</td>
													<td>".$row['tbed']."</td>
													<td>".$row['cin']."</td>
													<td>".$row['cout']."</td>
