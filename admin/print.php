	...
	?>
		<header>
			...
			<address >
				...
				<p>Sơn Tây<br>Hà Nội,<br>Viet Nam.</p>
				<p>(+84) 5555555</p>
			</address>
		...
		<article>
			...
			<table class="inventory">
				...
				<tbody>
					...
					<tr>
						<td><span ><?php echo $bed; ?> Giường </span></td>
						<td><span ><?php echo $days; ?></span></td>
			...
			<table class="balance">
				...
				<tr>
					<th><span >Số tiền phải trả</span></th>
					<td><span data-prefix>$</span><span><?php echo $fintot; ?></span></td>
				</tr>
			</table>
		</article>
		<aside>
			<h1><span >Liên hệ chúng tôi</span></h1>
			<div >
				<p align="center">Email :- info@gmail.com || Web :- www.abcxyz.com || Phone :- +84 55555 </p>
			</div>
		</aside>
	</body>
</html>
