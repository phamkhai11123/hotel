        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a  class="active-menu" href="room.php" style="background-color: #225081"><i class="fa fa-plus-circle"></i>Thêm phòng</a>
                    </li>
                    <li>
						...
						<form name="form" method="post">
							...
							<?php
							 ...
							 if(isset($_POST['add']))
							 {
										...
										{
										 echo '<script>alert("Phòng mới được thêm") </script>' ;
										}else {
											echo '<script>alert(" Hãy kiểm tra lại") </script>' ;
										}
